...
#response = supabase.table("objetos").select("*").execute()

#print("mesaje de supabase", response.data)
...
with st.form("add_ticket_form"):
    ...
    item_description = st.text_input("Descripción")
    item_image = st.file_uploader("Subir imagen")


    issue = st.text_area("Descripcion")
...
if submitted:
    ...
    data_submit = {
        ...
        "item_image_url": "oli",
        "item_status": "Perdido",
        "item_owner": "David Piñones"
    }
    df_submit = pd.DataFrame(data_submit)
    data_submit = df_submit.to_json(oriented="records")
